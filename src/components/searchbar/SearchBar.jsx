...
export default function SearchBar({ busca, setBusca}) {
  return (
    <div className={`relative flex items-cente bg-gray-200 border border-slate-200 rounded-lg md:rounded-xl px-2 md:px-3 py-2 w-full md:max-w-sm lg:max-w-md shadow-2xs focus-within:border-indigo-700 focus-within:ring-1 focus-within:ring-indigo-700 transition-all group`}>
